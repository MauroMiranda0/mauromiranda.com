...
export const developmentProjects = [
  ...
  {
    id: 'fresa-web',
    title: 'Panel de control de Fresa Web',
    category: 'Gestión Web',
    status: 'EN_DESARROLLO_061',
    description: 'Panel de control para Fresa Web con enfoque en gestión operativa, navegación administrativa y visualización clara de módulos clave del sistema.',
    image: 'https://images.unsplash.com/photo-1559028012-481c04fa702d?w=400&h=400&fit=crop&crop=center',
    tags: ['Dashboard', 'Gestión', 'Admin', 'UX'],
    gradient: 'linear-gradient(135deg, #1f1028 0%, #5b214a 55%, #f472b6 160%)',
    demoUrl: '/desarrollo/distFresaWeb/',
    previewUrl: '/desarrollo/distFresaWeb/index.html',
    githubUrl: 'https://github.com/MauroMiranda0',
    gridSize: 'small'
  },
  {
    ...
    image: '/desarrollo/distMedicinaEstetica/imgMedicinaEstetica/relleno botox.avif',
    tags: ['Landing', 'Citas', 'Salud', 'UX'],
    gradient: 'linear-gradient(135deg, #0f172a 0%, #0c3554 55%, #0ea5e9 155%)',
    demoUrl: '/desarrollo/distMedicinaEstetica/',
    previewUrl: '/desarrollo/distMedicinaEstetica/index.html',
    githubUrl: 'https://github.com/MauroMiranda0',
    gridSize: 'small'
  },
  {
    ...
    image: '/desarrollo/distEdalum/img/carousel-1.png',
    tags: ['Catálogo', 'E-commerce', 'Iluminación', 'Lead'],
    gradient: 'linear-gradient(135deg, #0f172a 0%, #1d4ed8 55%, #60a5fa 160%)',
    demoUrl: '/desarrollo/distEdalum/',
    previewUrl: '/desarrollo/distEdalum/index.html',
    githubUrl: 'https://github.com/MauroMiranda0',
    gridSize: 'small'
  },
  {
...
export const laboratoryProjects = [
  ...
  },
  {
    ...
    previewUrl: './experimentos/dashboard-template/index.html',
  ...
  {
    id: 'crud-avanzado-lab',
    title: 'CRUD Avanzado',
    category: 'Interfaces de Gestión',
    status: 'R&D_LAB_05',
    description: 'Exploración visual de una interfaz CRUD avanzada con estructura administrativa, módulos operativos y una composición pensada para flujos reales de gestión.',
    image: './experimentos/dashboard-template/vistaPrevia.png',
    previewUrl: './experimentos/dashboard-template/index.html',
    tags: ['CRUD', 'Dashboard', 'UI Admin', 'Responsivo'],
    demoUrl: './experimentos/dashboard-template/index.html',
    githubUrl: 'https://github.com/MauroMiranda0/mauromiranda.com/tree/main/experimentos/dashboard-template',
    gridSize: 'small'
  },
  {
    id: 'visualizador-codigo',
    title: 'Visualizador de Código',
    category: 'Herramientas Visuales',
    status: 'R&D_LAB_06',
    description: 'Visualizador interactivo de código con editor, panel de vista previa y lectura estructurada del contenido para demos técnicas en navegador.',
    image: './experimentos/proyectoVisualizarCodigo/index.html',
    previewUrl: './experimentos/proyectoVisualizarCodigo/index.html',
    tags: ['Código', 'Preview', 'UI', 'Herramienta'],
    demoUrl: './experimentos/proyectoVisualizarCodigo/index.html',
    githubUrl: 'https://github.com/MauroMiranda0/mauromiranda.com/tree/main/experimentos/proyectoVisualizarCodigo',
    gridSize: 'small'
  },
  {
